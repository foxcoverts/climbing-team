    ...
    @canany(['viewAny', 'create'], App\Models\User::class)
        <div>
            ...
            @can('viewAny', App\Models\User::class)
                <x-sidebar.link route='user.index' :match-routes="['user.index', 'user.show', 'user.edit', 'user.booking.*', 'user.qualification.*']" :label="__('View Users')">
                    <x-slot:icon>
                        <path
    ...
    @if (auth()->user()?->isTeamLeader() ?? false)
        <div>
            ...
            @can('viewAny', App\Models\Key::class)
                <x-sidebar.link route='key.index' :match-routes="['key.*']" :label="__('Keys')">
                    <x-slot:icon>
                        <path
