        ...
        <div class="text-gray-700 dark:text-gray-300">
            @forelse ($qualifications as $qualification)
                <div class="py-2 px-4 sm:px-8 hover:bg-gray-100 hover:dark:text-gray-200 dark:hover:bg-gray-700 border-b cursor-pointer"
                    ...
                    @click="window.location={{ Js::from(route('profile.qualification.show', [$qualification])) }}">
                    <h3 class="font-medium"><a
                            href="{{ route('profile.qualification.show', [$qualification]) }}">{{ $qualification->detail->summary }}</a>
                    </h3>
