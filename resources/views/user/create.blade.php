                        ...
                        <form method="post" action="{{ route('user.store') }}" class="mt-6 space-y-6"
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                    :value="old('name', $user->name)" maxlength="255" required autofocus x-model.fill="user.name" />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email" class="mt-1 block w-full"
                                    :value="old('email', $user->email)" maxlength="255" required x-model.fill="user.email" />
